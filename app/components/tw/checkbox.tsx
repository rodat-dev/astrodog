  ...
  return (
    <Headless.Checkbox
      ...
      className={clsx(
        [colors],
        className,
        "border-1 *:not-empty:outline-white *:not-empty:outline-2 group inline-flex cursor-pointer rounded-2xl border-white/50 focus:outline-none",
      )}
    >
      <span className="flex content-center justify-center rounded-full p-1 text-center opacity-0 transition-all group-data-[checked]:opacity-100">
        🐶
      </span>
    </Headless.Checkbox>
  );
