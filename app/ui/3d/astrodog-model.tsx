...
JSX.IntrinsicElements['group'] & {
    ...
    useFrame(({ clock, camera }) => {
        // To move the dog instead
        // =============================
        group.current?.position.setY(
            lerp(group.current?.position.y, positionY, 0.04)
        )

        // camera.position.setY(lerp(camera.position.y, positionY, 0.04))

        // camera.position.setY(lerp(camera.position.y, positionY, 0.05));
        // if (group.current) {
        //   if (hide) {
        //     camera.position.setY(
        //       lerp(camera.position.y, group.current.position.y - 60, 0.05),
        //     );
        //     if (camera.position.y - group.current.position.y - 60 > 0.1) {
        //       setHide(false);
        //     }
        //   } else {
        //     camera.position.setY(
        //       lerp(camera.position.y, group.current.position.y + 15, 0.05),
        //     );
        //   }
        // }
